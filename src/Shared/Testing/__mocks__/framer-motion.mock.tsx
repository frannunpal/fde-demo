...
import { createElement, type ReactNode, type HTMLAttributes, type ElementType } from 'react';
import { MOTION_PROPS, useAnimationControls } from './framer-motion-utils';

type MotionProps = HTMLAttributes<HTMLElement> & { children?: ReactNode; [key: string]: unknown };
