...
describe('LinkedinApp', () => {
  ...
  it('should open LinkedIn in a new tab when button is clicked', () => {
    ...
    fireEvent.click(screen.getByRole('button', { name: /open francisco núñez profile/i }));

    expect(openSpy).toHaveBeenCalledWith(LINKEDIN_URL, '_blank', 'noopener,noreferrer');
