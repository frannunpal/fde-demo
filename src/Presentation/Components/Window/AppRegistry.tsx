...
export const userApps: Record<string, AppRegistryEntry> = {
  ...
  linkedin: {
    loader: () =>
      import("@presentation/Components/Apps/LinkekinApp/LinkedinApp"),
    isLazy: true,
  },
  github: {
  ...
  terminal: {
    loader: () =>
      import("@fde-desktop/fde-core").then((m) => ({ default: m.TerminalApp })),
    isLazy: true,
  },
  "code-server": {
    loader: () =>
      import("@fde-desktop/fde-core").then((m) => ({
        default: m.CodeServerApp,
      })),
    isLazy: true,
  },
  storybook: {
